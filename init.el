...
(defvar my-keys-minor-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key god-local-mode-map (kbd "i") #'god-mode) ; toggle to disable god-mod globally
